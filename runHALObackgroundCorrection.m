...
for DATEi = datenum(num2str(DATEstart),'yyyymmdd'):...
    ...
    for i = 1:length(Stare_halo_files)
        [Stare_data1,Stare_att1,Stare_dim1] = ...
            load_nc_struct([C.dir_original_stare  ...
        ...
        if lrow == length(Stare_data1.(corrtd_fnames{1}))
            Stare_data1.([corrtd_fnames{3} '_' ...
            C.corrected_filename_identifier]) = snr_corr_2(...
        ...
        % write new file
        write_nc_struct([C.dir_corrected_stare thedate(1:4) '/' ...
    ...
    for i = 1:length(PPI_halo_files)
        [PPI_data1,PPI_att1,PPI_dim1] = ...
            load_nc_struct([C.dir_original_ppi  ...
        ...
        % write new file
        write_nc_struct([C.dir_corrected_ppi thedate(1:4) '/' ...
