...
calibrateHALO('site',[YYYYMMDD YYYYMMDD])
...
### 3) Calculate winds with uncertainties
  ...
  calculateHALOwindvadProduct('site',[YYYYMMDD YYYYMMDD],'NN')
  ...
  calculateHALOwinddbsProduct('site',[YYYYMMDD YYYYMMDD],'noofbeams')
...
calculateHALOwindShearProduct('site',[YYYYMMDD YYYYMMDD],'windproduct','typeof')
...
calculateHALOwStatsProduct('site',[YYYYMMDD YYYYMMDD])
...
calculateHALOverticalTKEproduct('site',[YYYYMMDD YYYYMMDD],'windproduct','typeof')
...
calculateHALOcloudProduct('site',[YYYYMMDD YYYYMMDD])
...
calculateHALOatmBLclassificationProduct('site',[YYYYMMDD YYYYMMDD])
...
calculateHALObetaVeloCovarianceProduct('site',[YYYYMMDD YYYYMMDD])
