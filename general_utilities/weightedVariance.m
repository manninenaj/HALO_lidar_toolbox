function y_var = weightedVariance(y,y_error,method)
%weightedVariance calculates either weighted or unweighted variance unbiased by
%Gaussian noise and sample-size. Uses methods presented by Rimoldini (2014)
%http://dx.doi.org/10.1016/j.ascom.2014.02.001
%
%Usage:
%y_var = weightedVariance(y,y_error)
%y_var = weightedVariance(y,y_error,method)
%
%Inputs:
%-y         numerical vector of values the variance is calculated from
