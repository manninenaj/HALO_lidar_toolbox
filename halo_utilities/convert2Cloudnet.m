...
%% Create attributes
%
att1.v_error0.comments = 'Standard deviation of velocity calculated from original signal';
att1.v_error.comments = 'Standard deviation of velocity calculated from corrected signal';
% radial velocity (raw)
...
att1.global.day   = str2double(thedate(7:8));
att1.global.month = str2double(thedate(5:6));
att1.global.year  = str2double(thedate(1:4));
